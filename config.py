...
OWNER_USERNAME = getenv("OWNER_USERNAME","iamcutehero1")
...
EVALOP = list(map(int, getenv("EVALOP", "6343729323").split()))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Royalhero56/HEROxMUSIC",
)
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/@Ayuuubby")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://graph.org/file/57eb05aba7008c2419046.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://graph.org/file/57eb05aba7008c2419046.jpg"
)
